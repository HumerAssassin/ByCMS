...
<head>
    ...
    <meta name="description" content="Users logins the system through this page." />
        ...
        <div class="col-md-4 col-md-offset-4">
            <form name="form1" action="#" class="fh5co-form animate-box" data-animate-effect="fadeIn" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="username" type="text" class="form-control" id="username" placeholder="用户名" autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="password" class="sr-only">Password</label>
                    <input name="pswd" type="password" class="form-control" id="password" placeholder="密码" autocomplete="off">
                </div>
                <div class="form-group">
                    <p>没有账号？<a href="signup.jsp">注册</a></p>
                </div>
                <div class="form-group">
